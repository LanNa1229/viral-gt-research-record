...
The original historical published extraction script has now been recovered and verified (2026-09-12). The 4,555-byte source from `/scratch/ln72030/BGC_Prophet/extract_bgc_embeddings.py` exactly matches historical SHA256 `33e6a9eb5d07e7634b3033d96667c450be1b3b7da9dcf8417600dbdd4ff3f616`. It is archived byte-for-byte with its [execution documentation](../../scripts/archive/WP07_mibig_reference_atlas/published_style_extraction/README.md); the [recovery manifest](../../metadata/manifests/DS-VGT-20260911-001_recovered_extraction.json) supersedes the earlier missing-source status. No replacement implementation or historical SBATCH launcher was added. The extracted LMDB's documented local path is currently absent; its retained archive and historical checksums are recorded separately. Checkpoint identity is a historical HPC checksum, not a new local verification. The artificial MIBiG protein-ID to amino-acid crosswalk remains unresolved; this record makes no sequence reconstruction claim.
